...
const EditArtikelContent = () => {
    ...
    const fetchArtikels = useCallback(async (page: number, search: string, itemsPerPage: number) => {
        ...
        try {
            ...
            Swal.fire('Error', 'Failed to retrieve article data.', 'error');
    ...
    const handleDelete = async (artikelId: string) => { // Mengubah tipe id menjadi string
        Swal.fire({
            title: 'Are you sure?',
            text: "You will not be able to return this article!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                try {
                    ...
                    Swal.fire('Failed!', 'An error occurred while deleting the article.', 'error');
                } finally {
                    setDeletingId(null);
                }
            }
    ...
    return (
        <div className="container mx-auto px-4 py-3">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">List Your Articles</h1>
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-10">
                ...
                {loading && artikels.length === 0 ? (
                    ...
                    <div className="text-center text-gray-500 dark:text-gray-400 py-10">
                        <p className="mb-4 text-lg">No articles were found with your search criteria.</p>
                        <button
