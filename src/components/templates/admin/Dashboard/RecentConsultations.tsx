...
const RecentConsultations: React.FC<RecentConsultationsProps> = ({ data = [] }) => {
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-gray-200">
            <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex space-x-2">
                    ...
                    <button className="flex items-center space-x-1 text-gray-500 hover:text-pink-600 text-sm font-medium transition-colors px-2 py-1 rounded-lg hover:bg-pink-50">
